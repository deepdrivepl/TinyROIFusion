...
class SeaDronesSeeDataset():
    ...
    def __init__(self, split='val', root_dir='/TinyROITrack/data/SeaDronesSee', flist=None, name=None):
        ...
        self.original_classes =  ["swimmer", "swimmer with life jacket", "boat", "life jacket"]
        self.classes =  ["swimmer", "swimmer+PFD", "boat", "PFD"]
        ...
        with open('data/SeaDronesSee/seq2imgs.json', 'w', encoding='utf-8') as f:
            json.dump(self.seq2imgs, f, ensure_ascii=False, indent=4)
